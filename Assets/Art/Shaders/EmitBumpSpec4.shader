Shader "EmitBumpSpec4"
{
	Properties 
	{
_Main("_Main", Color) = (0.1373811,0.2048307,0.8897059,1)
_Spec1("_Spec1", Color) = (0.7720588,0,0,1)
_Emit("_Emit", Color) = (1,1,1,1)
...
float4 Multiply2=Tex2D0.aaaa * _Emit;
float4 Tex2D1=tex2D(_Spec,(IN.uv_Spec.xyxy).xy);
float4 Multiply0=_Spec1 * Tex2D1;
