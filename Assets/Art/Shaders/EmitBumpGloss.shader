Shader "EmitBumpGloss"
{
	Properties 
	{
_MainColor("_MainColor", Color) = (0.2573529,0.1892301,0.1892301,1)
_EmitColor("_EmitColor", Color) = (0.5661765,0.2248054,0.2248054,1)
_Diff("_Diff", 2D) = "black" {}
_Spec("_Spec", 2D) = "black" {}
_Normal("_Normal", 2D) = "bump" {}
_Gloss("_Gloss", Range(0.1,2) ) = 2
...
float4 Multiply2=Tex2D2.aaaa * _Gloss.xxxx;
